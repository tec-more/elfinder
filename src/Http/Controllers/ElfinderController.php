<?php namespace Tukecx\Base\Elfinder\Http\Controllers;

use Tukecx\Base\Core\Http\Controllers\BaseAdminController;
use Tukecx\Base\Elfinder\Support\Connector;

class ElfinderController extends BaseAdminController
{
    protected $module = 'tukecx-elfinder';
    ...
    {
        $this->breadcrumbs->addLink('所有文件');

        $this->getDashboardMenu($this->module);

        $this->setPageTitle('所有文件');
        ...
        if (empty($roots)) {
            ...
            foreach ($dirs as $dir) {
                ...
                $roots[] = [
                    ...
                    'accessControl' => 'Tukecx\Base\Elfinder\Http\Controllers\ElfinderController::checkAccess', // filter callback (OPTIONAL),
                    'autoload' => true,
